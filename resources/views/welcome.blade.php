...
<head>
    ...
    <script>
        ...
        {
            var area = document.querySelector(`#${text_id}`);
            var offsetHeight = 10;
    ...
    <div class="mx-auto sm:px-6 pt-16 lg:px-8 w-11/12" style="max-height:880px">
        <div class="flex h-full">
            <div class="basis-1/3 z-10 bg-white flex flex-col">
                ...
                <div class="border-r-[1px] flex-1 border-slate-200 overflow-y-auto overflow-hidden scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-white-100">
                    <ul role="list" class="">

                    </ul>
                </div>
            </div>
            <div class="basis-2/3 z-10 flex flex-col">
                ...
                <div class="flex-1 chat-content" style="background: url({{ asset('images/messages_background.jpg') }}); background-size: contain;">

                </div>
                <div class="flex space-x-4 text-[24px] items-center p-4 h-max text-slate-500 border-slate-300 bg-slate-200 h-16 w-full">
                    <div>
